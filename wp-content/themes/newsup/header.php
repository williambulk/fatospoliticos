...
<?php _e( 'Skip to content', 'newsup' ); ?></a>
    <div class="wrapper">
        <header class="mg-headwidget">
            ...
            $newsup_header_overlay_color = get_theme_mod('newsup_header_overlay_color');
              ?>
            <div class="overlay">
              <div class="inner" style="background-color:<?php echo esc_attr($newsup_header_overlay_color);?>;">
              <?php } ?> 
